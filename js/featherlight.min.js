...
// for older than IE9 browser upgrade alert
...
if ($('html').hasClass('oldie') == true && ieAlert != 'closed') {
	jQuery(function ($) {
		var content = '\
					<div id="ie_alert" class="lightbox">\
					  ...
					  <a class="ie_upgrade_btn" href="http://browsehappy.com/" target="_blank">Upgrade Now</a>\
					</div>'
